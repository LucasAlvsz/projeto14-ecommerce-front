      ...
      <form autoComplete="off" onChange={(e) => handleForm(e)}>
        <div>
          <label>
            ...
            <br />
            <span className="notice">Funciona apenas o cartão</span>
          </label>
          <S.PaymentContainer>
            <S.PaymentButton
            ...
            >
              <CreditIcon title="credit" name="credit" />
            </S.PaymentButton>
            <S.PaymentButton
              ...
              onClick={(e) => handleSelected(e)}
            >
              <MoneyIcon title="cash" name="cash" />
            </S.PaymentButton>
            <S.PaymentButton
              ...
              onClick={(e) => handleSelected(e)}
            >
              <InvoiceIcon title="ticket" name="ticket" />
            </S.PaymentButton>
          </S.PaymentContainer>
        </div>
